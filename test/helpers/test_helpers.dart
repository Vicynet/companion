...
@GenerateMocks([], customMocks: [
  ...
  MockSpec<BibleDataService>(onMissingStub: OnMissingStub.returnDefault),
...
void registerServices() {
  ...
  getAndRegisterBibleDataService();
...
MockBibleDataService getAndRegisterBibleDataService() {
  _removeRegistrationIfExists<BibleDataService>();
  final service = MockBibleDataService();
  locator.registerSingleton<BibleDataService>(service);
  return service;
}
