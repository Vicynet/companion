...
// in companion/test/helpers/test_helpers.dart.
...
/// A class which mocks [BibleDataService].
///
/// See the documentation for Mockito's code generation for more information.
class MockBibleDataService extends _i1.Mock implements _i7.BibleDataService {
  @override
  _i5.Future<Map<String, dynamic>?> readJson() => (super.noSuchMethod(
        Invocation.method(
          #readJson,
          [],
        ),
  ...
  @override
  List<String> getBooks() => (super.noSuchMethod(
        Invocation.method(
          #getBooks,
          [],
        ),
  ...
  @override
  List<int> getChapters(String? bookName) => (super.noSuchMethod(
        Invocation.method(
          #getChapters,
          [bookName],
        ),
  ...
  @override
  List<String> getVersions() => (super.noSuchMethod(
        Invocation.method(
          #getVersions,
          [],
        ),
  ...
  @override
  List<String> getLanguages() => (super.noSuchMethod(
        Invocation.method(
          #getLanguages,
          [],
        ),
  ...
  _i5.Future<List<_i8.SessionConversations>?>
      getAllSessionsWithConversations() => (super.noSuchMethod(
            Invocation.method(
              #getAllSessionsWithConversations,
              [],
            ),
            returnValue: _i5.Future<List<_i8.SessionConversations>?>.value(),
            returnValueForMissingStub:
                _i5.Future<List<_i8.SessionConversations>?>.value(),
...
class MockGeminiService extends _i1.Mock implements _i9.GeminiService {
  ...
  @override
  _i5.Future<_i8.SessionConversations?> continousAIConversation(
    String? query,
    String? sessionId,
...
class MockDatabaseService extends _i1.Mock implements _i11.DatabaseService {
  ...
  @override
  _i5.Future<_i8.SessionConversations?> fetchConversationsById(
          String? conversationId) =>
      (super.noSuchMethod(
        Invocation.method(
          #fetchConversationsById,
          [conversationId],
        ),
        returnValue: _i5.Future<_i8.SessionConversations?>.value(),
        returnValueForMissingStub:
  ...
  @override
  _i5.Future<List<_i8.SessionConversations>>
      fetchAllSessionsWithConversations() => (super.noSuchMethod(
            Invocation.method(
              #fetchAllSessionsWithConversations,
              [],
            ),
            returnValue: _i5.Future<List<_i8.SessionConversations>>.value(
                <_i8.SessionConversations>[]),
            returnValueForMissingStub:
                _i5.Future<List<_i8.SessionConversations>>.value(
                    <_i8.SessionConversations>[]),
          ) as _i5.Future<List<_i8.SessionConversations>>);
